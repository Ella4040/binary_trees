...
binary_tree_t *binary_tree_insert_left(binary_tree_t *parent, int value)
{
    ...
    if (parent->left != NULL)
    {
        ...
        parent->left->parent = new; // Updates the parent of the old left child to point to the new node.
    }

    parent->left = new_node; /*Updates the left child of the parent to point to the new node*/
